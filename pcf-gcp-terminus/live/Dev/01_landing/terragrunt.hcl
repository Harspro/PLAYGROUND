...
inputs = {
  ...
  project_id_curated                     = "pcb-dev-curated"
  is_project_number                      = true
  cloudstorage_name                      = "landing-zone"
  retention_days                         = 70
  landing_sa                             = "infra-admin-sa@pcb-dev-landing.iam.gserviceaccount.com"
  curated_sa                             = "infra-admin-sa@pcb-dev-curated.iam.gserviceaccount.com"
  monitoring-bq-sa                       = "monitoring-bq-sa@pcb-dev-curated.iam.gserviceaccount.com"
  monitoring_sa                          = "monitoring-prometheus@pcb-dev-processing.iam.gserviceaccount.com"
  ...
  ctt_dataset_curated                    = "cots_customer_service_ctt_vw"
  ...
  money_movement_composer_webserver_uri  = dependency.processing_zone.outputs.money_movement_composer_web_uri
  enable_pdf_afp_landing_bucket_access   = false
  all_score_sa                           = "pcb-all-score-sa@pcb-dev-processing.iam.gserviceaccount.com"
  switch_sa                              = "pcb-switch-sa@pcb-dev-processing.iam.gserviceaccount.com"

  data_management_poc_flag = 1


  vpc_connectors = {
    name = "pcb-dev-landing-connector"
  ...
  bq_dataset_ids     = {
    ...
    dataops_driver                    =  "dataops_driver"
    dataops_its                       =  "dataops_its"
    dataops_poc                       =  "dataops_poc"
    snapshot_archive                  =  "snapshot_archive"
    domain_poa                        =  "domain_poa"
  ...
  pubsub_topic_sub  = [
    ...
    {
      name         = "pcb-data-ctt-stat-agent-activity-i"
      dlq_name     = "pcb-data-ctt-stat-agent-activity-i-dlt"
      subscription = "pcb-data-ctt-stat-agent-activity-i-sub"
      schema_name  = "pcb-data-ctt-stat-agent-activity-i-schema"
      schema_file  = "StatAgentActivityI.json"
      bq_table_name = "STAT_AGENTACTIVITY_I"
    },
    {
    ...
    {
      name         = "pcb-data-ctt-stat-queue-activity-i"
      dlq_name     = "pcb-data-ctt-stat-queue-activity-i-dlt"
      subscription = "pcb-data-ctt-stat-queue-activity-i-sub"
      schema_name  = "pcb-data-ctt-stat-queue-activity-i-schema"
      schema_file  = "StatQueueActivityI.json"
      bq_table_name = "STAT_QUEUEACTIVITY_I"
    },
    {
    ...
    {
      name         = "pcb-data-ctt-stat-workflow-action-activity-i"
      dlq_name     = "pcb-data-ctt-stat-workflow-action-activity-i-dlt"
      subscription = "pcb-data-ctt-stat-workflow-action-activity-i-sub"
      schema_name  = "pcb-data-ctt-stat-workflow-action-activity-i-schema"
      schema_file  = "StatWorkflowActionActivityI.json"
      bq_table_name = "STAT_WORKFLOWACTIONACTIVITY_I"
    },
    {
      name         = "pcb-data-ctt-stat-agent-line-of-business-i"
      dlq_name     = "pcb-data-ctt-stat-agent-line-of-business-i-dlt"
      subscription = "pcb-data-ctt-stat-agent-line-of-business-i-sub"
      schema_name  = "pcb-data-ctt-stat-agent-line-of-business-i-schema"
      schema_file  = "StatAgentLineOfBusinessI.json"
      bq_table_name = "STAT_AGENTLINEOFBUSINESS_I"
    },
    {
      name         = "pcb-data-ctt-stat-dnis-activity-i"
      dlq_name     = "pcb-data-ctt-stat-dnis-activity-i-dlt"
      subscription = "pcb-data-ctt-stat-dnis-activity-i-sub"
      schema_name  = "pcb-data-ctt-stat-dnis-activity-i-schema"
      schema_file  = "StatDnisActivityI.json"
      bq_table_name = "STAT_DNISACTIVITY_I"
    },
    {
      name         = "pcb-data-ctt-stat-skill-activity-i"
      dlq_name     = "pcb-data-ctt-stat-skill-activity-i-dlt"
      subscription = "pcb-data-ctt-stat-skill-activity-i-sub"
      schema_name  = "pcb-data-ctt-stat-skill-activity-i-schema"
      schema_file  = "StatSkillActivityI.json"
      bq_table_name = "STAT_SKILLACTIVITY_I"
    },
    {
      name         = "pcb-data-ctt-stat-trunk-activity-i"
      dlq_name     = "pcb-data-ctt-stat-trunk-activity-i-dlt"
      subscription = "pcb-data-ctt-stat-trunk-activity-i-sub"
      schema_name  = "pcb-data-ctt-stat-trunk-activity-i-schema"
      schema_file  = "StatTrunkActivityI.json"
      bq_table_name = "STAT_TRUNKACTIVITY_I"
    },
    {
      name         = "pcb-data-ctt-stat-agent-not-ready-breakdown-i"
      dlq_name     = "pcb-data-ctt-stat-agent-not-ready-breakdown-i-dlt"
      subscription = "pcb-data-ctt-stat-agent-not-ready-breakdown-i-sub"
      schema_name  = "pcb-data-ctt-stat-agent-not-ready-breakdown-i-schema"
      schema_file  = "StatAgentNotReadyBreakdownI.json"
      bq_table_name = "STAT_AGENTNOTREADYBREAKDOWN_I"
    },
    {
      name         = "pcb-data-ctt-stat-cdr-summary"
      dlq_name     = "pcb-data-ctt-stat-cdr-summary-dlt"
      subscription = "pcb-data-ctt-stat-cdr-summary-sub"
      schema_name  = "pcb-data-ctt-stat-cdr-summary-schema"
      schema_file  = "StatCdrSummary.json"
      bq_table_name = "STAT_CDR_SUMMARY"
    },
    {
      name          = "pcb-data-ctt-stat-agent-activity-by-queue-i"
      dlq_name      = "pcb-data-ctt-stat-agent-activity-by-queue-i-dlt"
      subscription  = "pcb-data-ctt-stat-agent-activity-by-queue-i-sub"
      schema_name   = "pcb-data-ctt-stat-agent-activity-by-queue-i-schema"
      schema_file   = "StatAgentActivityByQueueI.json"
      bq_table_name = "STAT_AGENTACTIVITYBYQUEUE_I"
    }
  ]
  pubsub_to_bq = [
    {
  ...
  bq_tables = {
    ...
    cnsld_lylty_bskt_item_offr = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "cnsld_lylty_bskt_item_offr"
      schema_file         = "/bq_table_schemas/loyalty/points_comprehension/cnsld_lylty_bskt_item_offr.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
    ...
    cnsld_lylty_bskt_sum = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "cnsld_lylty_bskt_sum"
      schema_file         = "/bq_table_schemas/loyalty/points_comprehension/cnsld_lylty_bskt_sum.json"
      deletion_protection = false
      clustering          = ["pos_trans_id"]
      time_partitioning   = {
        type                     = "DAY",
        expiration_ms            = null,
        field                    = "trans_dt",
    ...
    cnsld_ee_wallt_acct_tran_latst = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "cnsld_ee_wallt_acct_tran_latst"
      schema_file         = "/bq_table_schemas/loyalty/points_comprehension/cnsld_ee_wallt_acct_tran_latst.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
    ...
    ee_identity = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "ee_identity"
      schema_file         = "/bq_table_schemas/loyalty/points_comprehension/ee_identity.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
        expiration_ms            = null,
        field                    = "business_effective_date",
        require_partition_filter = true
      }
    },
    ee_wallet_transaction_payment = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "ee_wallet_transaction_payment"
      schema_file         = "/bq_table_schemas/loyalty/points_comprehension/ee_wallet_transaction_payment.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
    ...
    orders_changelog_latest = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "orders_changelog_latest"
      schema_file         = "/bq_table_schemas/loyalty/points_comprehension/orders_changelog_latest.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = null
    },
    payment_methods_raw_latest = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "payment_methods_raw_latest"
      schema_file         = "/bq_table_schemas/loyalty/points_comprehension/payment_methods_raw_latest.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = null
    },
    pc_subscriptions = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "pc_subscriptions"
      schema_file         = "/bq_table_schemas/loyalty/points_comprehension/pc_subscriptions.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
    ...
    power_of_attorney = {
      bq_dataset_id       = "domain_poa"
      bq_table_id         = "POWER_OF_ATTORNEY"
      schema_file         = "/bq_table_schemas/power_of_attorney.json"
      deletion_protection = false
      clustering          = ["customer_uid", "account_uid"]
      time_partitioning   = null
    },
    tsys_comms_event = {
      bq_dataset_id       = "domain_communication"
    ...
    communication_request_rti = {
      bq_dataset_id       = "domain_communication"
      bq_table_id         = "COMMUNICATION_REQUEST_RTI"
      schema_file         = "/bq_table_schemas/communications/communication_request_rti.json"
      deletion_protection = true
      clustering          = ["code"]
      time_partitioning   = {
        type                     = "DAY",
    ...
    communication_event_rti = {
      bq_dataset_id       = "domain_communication"
      bq_table_id         = "COMMUNICATION_EVENT_RTI"
      schema_file         = "/bq_table_schemas/communications/communication_event_rti.json"
      deletion_protection = true
      clustering          = ["channel", "statusCode", "communicationCode"]
      time_partitioning   = {
        type                     = "DAY",
        expiration_ms            = 315569260000,
        field                    = "timestamp",
    ...
    terminus_accounts_driver = {
      bq_dataset_id       = "dataops_driver"
      bq_table_id         = "ACCOUNTS"
      schema_file         = "/bq_table_schemas/terminus_accounts.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = null
    },
    terminus_accounts_its = {
      bq_dataset_id       = "dataops_its"
      bq_table_id         = "ACCOUNTS"
      schema_file         = "/bq_table_schemas/terminus_accounts.json"
      deletion_protection = false
      clustering          = null
    ...
    terminus_accounts_poc = {
      bq_dataset_id       = "dataops_poc"
      bq_table_id         = "ACCOUNTS"
      schema_file         = "/bq_table_schemas/terminus_accounts.json"
      deletion_protection = false
      clustering          = null
    ...
    dag_job_ref = {
      bq_dataset_id       = "domain_technical"
      bq_table_id         = "DAG_JOB_REF"
      schema_file         = "/bq_table_schemas/dag_job_ref.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = null
    },
    dag_job_result = {
      bq_dataset_id       = "domain_technical"
      bq_table_id         = "DAG_JOB_RESULT"
      schema_file         = "/bq_table_schemas/dag_job_result.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = null
    },
    ...
    purgelist_exclusion_gs = {
      bq_dataset_id       = "domain_customer_acquisition"
      bq_table_id         = "PURGELIST_EXCLUSION_GS"
      schema_file         = "/bq_table_schemas/applications/purgelist_exclusion.json"
      deletion_protection = false
      clustering          = null
      external_data_configuration = {
        source_uris = ["https://docs.google.com/spreadsheets/d/1l4YmeTrW-054lBrqSsdg4Mp17x7fXHWCDZ6ovefBJAk/edit?gid=0#gid=0"]
    ...
    loyalty_bulk_offer_account = {
      bq_dataset_id       = "domain_account_management"
      bq_table_id         = "LOYALTY_BULK_OFFER_ACCOUNT"
      schema_file         = "/bq_table_schemas/digital_adoption/eve_loyalty_offer/loyalty_bulk_offer_account.json"
      deletion_protection = false
      clustering          = ["pcmaAccountId"]
      time_partitioning   = {
        type                     = "DAY",
    ...
    customer_biller_changed = {
      bq_dataset_id       = "domain_payments"
      bq_table_id         = "CUSTOMER_BILLER_CHANGED"
      schema_file         = "/bq_table_schemas/customer_biller_changed.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
    ...
    interac_recipient_changed = {
      bq_dataset_id       = "domain_payments"
      bq_table_id         = "INTERAC_RECIPIENT_CHANGED"
      schema_file         = "/bq_table_schemas/interac_recipient_changed.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
    ...
    pcb_funds_move_cancelled = {
      bq_dataset_id       = "domain_payments"
      bq_table_id         = "PCB_FUNDS_MOVE_CANCELLED"
      schema_file         = "/bq_table_schemas/pcb_funds_move_cancelled.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
    ...
    pcb_eft_funds_in_rt = {
      bq_dataset_id       = "domain_payments"
      bq_table_id         = "PCB_EFT_FUNDS_IN_RT"
      schema_file         = "/bq_table_schemas/money_movement/pcb_eft_funds_in_rt.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
  ...
  pc_declined_app_offer_match = {
    ...
    click_to_pay_reprocessing_event = {
      bq_dataset_id       = "domain_customer_management"
      bq_table_id         = "CLICK_TO_PAY_REPROCESSING_EVENT"
      schema_file         = "/bq_table_schemas/digital_adoption/click_to_pay/click_to_pay_reprocessing_events.json"
      deletion_protection = false
      clustering          = null
      time_partitioning   = {
        type                     = "DAY",
    ...
    pco_scoring_file_status = {
      bq_dataset_id       = "domain_loyalty"
      bq_table_id         = "PCO_SCORING_FILE_STATUS"
      schema_file         = "/bq_table_schemas/loyalty/PCO/pco_scoring_file_status.json"
      deletion_protection = false
      clustering          = null
      time_partitioning = {
        type                     = "DAY",
    ...
    pin_unblock_request = {
      bq_dataset_id       = "domain_account_management"
      bq_table_id         = "PIN_UNBLOCK_REQUEST"
      schema_file         = "/bq_table_schemas/accounts/pin_unblock_request_status/pin_unblock_request.json"
      deletion_protection = false
      clustering          = null
      time_partitioning = {
        type                     = "DAY",
    ...
    pin_unblock_request_status = {
      bq_dataset_id       = "domain_account_management"
      bq_table_id         = "PIN_UNBLOCK_REQUEST_STATUS"
      schema_file         = "/bq_table_schemas/accounts/pin_unblock_request_status/pin_unblock_request_status.json"
      deletion_protection = false
      clustering          = null
      time_partitioning = {
        type                     = "DAY",
  ...
  ctt_bq_tables = [
   ...
   interac_bq_tables = [
      {
        table_name   = "RECON_ACCOUNT_REPORT"
        table_schema = "InteracReconcile.json"
      }
      ]
  ...
  business_projects_composer_sa = [
    "creditrisk-airflow@pcb-nonprod-creditrisk.iam.gserviceaccount.com",
    "creditriskecl-airflow@pcb-nonprod-creditrisk-ecl.iam.gserviceaccount.com",
    "creditriskscoring-airflow@pcb-nonprod-creditrisk-scoring.iam.gserviceaccount.com",
    "fraud-airflow@pcb-nonprod-fraud.iam.gserviceaccount.com",
    "pds-airflow@pcb-nonprod-pds.iam.gserviceaccount.com",
    "portfolio-mgmt@pcb-nonprod-portfolio-mgmt.iam.gserviceaccount.com",
    "pcb-erm@pcb-nonprod-erm.iam.gserviceaccount.com"
  ]
