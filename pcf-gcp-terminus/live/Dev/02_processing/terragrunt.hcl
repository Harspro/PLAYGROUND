...
inputs = {
  ...
  enable_pdf_afp_processing_bucket_access = false
  bq_dataset_ids = {
  ...
  landing_project_id         = "pcb-dev-landing"
  processing_sa              = "infra-admin-sa@pcb-dev-processing.iam.gserviceaccount.com"
  siem_pubsub_topic          = "pubsub.googleapis.com/projects/pcb-nonprod-dataflow/topics/pcb-nonprod-siem-logs"
  environment                = "dev"
  pdf_generation_cf_version  = "0.43.0"
  model_inference_cf_version = "1.0.0"

  vpc_connectors = {
    name               = "pcb-dev-proc-connector"
