...
inputs = {
  project_id                             = "pcb-uat-landing"
  project_zone                           = "landing"
  cloudstorage_name                      = "landing-zone"
  retention_days                         = 70
  is_project_number                      = true
  landing_sa                             = "infra-admin-sa@pcb-uat-landing.iam.gserviceaccount.com"
  monitoring-bq-sa                       = "monitoring-bq-sa@pcb-uat-curated.iam.gserviceaccount.com"
  monitoring_sa                          = "monitoring-prometheus@pcb-uat-processing.iam.gserviceaccount.com"
  ...
  all_score_sa                           = "pcb-all-score-sa@pcb-uat-processing.iam.gserviceaccount.com"
  switch_sa                              = "pcb-switch-sa@pcb-uat-processing.iam.gserviceaccount.com"

  data_management_poc_flag = 0

  vpc_connectors = {
    name               = "pcb-uat-landing-connector"
