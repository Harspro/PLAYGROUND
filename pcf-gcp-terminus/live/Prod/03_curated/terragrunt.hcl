...
inputs = {
  project_id                     = "pcb-prod-curated"
  project_id_landing             = "pcb-prod-landing"
  cots_mft_sterling              = "cots_mft_sterling"
  project_zone                   = "curated"
  cloudstorage_name              = "curated-zone"
  creditrisk_business_project_id = "pcb-prod-creditrisk-scoring"
  creditrisk_business_dataset_id = "TRS"
 ...
 pcma_cdic_0236 = {
  ...
  ctt_bq_views = [
    {
      ...
      query_file = "CustomContactDetailRecords.sql"
    },
    {
      table_name = "STAT_ADR"
      query_file = "StatAdr.sql"
    },
    {
      table_name = "STAT_AGENT_ACTIVITY_D"
      query_file = "StatAgentActivityD.sql"
    },
    {
      table_name = "STAT_AGENT_NOT_READY_BREAKDOWN_D"
      query_file = "StatAgentNotReadyBreakdownD.sql"
    },
    {
      table_name = "STAT_CDR"
      query_file = "StatCdr.sql"
    },
    {
      table_name = "TOUCH_POINT"
      query_file = "TouchPoint.sql"
    },
    {
      table_name = "CUSTOM_LOB"
      query_file = "CustomLob.sql"
    },
    {
      table_name = "NOT_READY_REASON_NAME"
      query_file = "NotReadyReasonName.sql"
    },
    {
      table_name = "LOB_NAME"
      query_file = "LobName.sql"
    },
    {
      table_name = "STAT_QUEUEACTIVITY_D"
      query_file = "StatQueueActivityD.sql"
    },
    {
      table_name = "STAT_AGENTACTIVITYBYQUEUE_D"
      query_file = "StatAgentActivityByQueueD.sql"
    }
  ]

  trs_bq_views = [
    {
      table_name = "trs_daily_input_table",
      query_file = "trs_daily_input_table.sql"
    },
    {
      table_name = "trs_daily_log",
      query_file = "trs_daily_log.sql"
    }
  ]
  ...
  cots_mft_sterling_views_bool = true
