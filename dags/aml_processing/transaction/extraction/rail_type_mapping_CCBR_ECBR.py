...
class RailTypeMappingCCBRECBR(RailTypeMappingBase):
    ...
    def get_funds_move_join(self) -> str:
        ...
        LEFT JOIN (
               ...
               FROM  `{self.project_curated}.domain_payments.CPA_AUTOPAY_REQ` in_cpa
               WHERE  in_cpa.REQUEST_TYPE = 'CREDIT'
             ) cpa
