-- Aggregation logic for Daily/Monthly/Initial Load ESSO Purchase PCO Base.
...
INNER JOIN `{table_ee_wallet_transaction_payment}` ee_payment ON
  cnsld_latest.wallettransactionid = ee_payment.wallettransactionid
...
AND LOWER(cnsld_latest.wallettransaction_type) = 'settle'
AND cnsld_latest.account_campaign_id in ('100248048','100248047','115094436','100367239','100367238','100367240','100367241')
