...
globals().update(BigQueryCustomQueryDeltaLoader(config_filename='bigquery_custom_query_dailyloader_config.yaml', loading_frequency=LoadingFrequency.Daily).create_dags())  # pragma: no cover
