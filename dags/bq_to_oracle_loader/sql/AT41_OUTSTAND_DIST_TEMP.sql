CREATE OR REPLACE TABLE pcb-{env}-processing.domain_account_management.AT41_OUTSTAND_DIST_TEMP
OPTIONS (
...
FROM
  pcb-{env}-landing.domain_account_management.AT41_OUTSTAND_DIST
WHERE
