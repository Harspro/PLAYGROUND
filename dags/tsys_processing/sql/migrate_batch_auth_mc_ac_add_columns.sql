-- Add the 5 new columns and TKN_PRIORITY to child table BATCH_AUTHORIZATION_MC_AC
...
ALTER TABLE `pcb-{env}-landing.domain_account_management.BATCH_AUTHORIZATION_MC_AC`
